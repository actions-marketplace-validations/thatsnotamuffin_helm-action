...
# Usage
see [example.yml](.github/example.yml)
    ...
    deploy:
        ...
        steps:
            ...
            - name: Deploy to EKS Cluster
              uses: thatsnotamuffin/muffin-helm
              env:
...
- cluster:
  ...
  name: arn:aws:eks:us-east-2:111222333444:cluster/thatsnotamuffin-cluster
contexts:
- context:
    cluster: arn:aws:eks:us-east-2:111222333444:cluster/thatsnotamuffin-cluster
    user: arn:aws:eks:us-east-2:111222333444:cluster/thatsnotamuffin-cluster
  name: arn:aws:eks:us-east-2:111222333444:cluster/thatsnotamuffin-cluster
current-context: arn:aws:eks:us-east-2:111222333444:cluster/thatsnotamuffin-cluster
kind: Config
preferences: {}
users:
- name: arn:aws:eks:us-east-2:111222333444:cluster/thatsnotamuffin-cluster
